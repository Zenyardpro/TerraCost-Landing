...
function App() {
  ...
  useEffect(() => { document.title = "TerraCost | Landscape Estimating & BOQ Software for Contractors, Designers & Architects"; }, []);
  useEffect(() => {
